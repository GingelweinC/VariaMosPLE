...
export default function AnnotationLayer({
    ...
    const getFlowPositionFromScreen = (screenX: number, screenY: number) => {
        try {
    ...
    const handleMouseMove = (e: MouseEvent) => {
        ...
        if (!currentDraggingId || !startPosition) return;
        ...
        const flowPosition = getFlowPositionFromScreen(screenX, screenY);
    ...
    const handleMouseUp = () => {
        ...
        if (
            currentDraggingId &&
            currentDragPreview?.id === currentDraggingId
        ) {
        ...
        <div className="annotation-layer">
            ...
            {annotations
                .filter((item) => {
                    ...
                    if (!item?.annotation?.position) return false;
